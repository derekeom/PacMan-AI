...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        # qvalues maps (state, action) to q-value
    ...
    def computeValueFromQValues(self, state):
        ...
        policy = self.getPolicy(state)  # get policy (best action)
        value = self.getQValue(state, policy)   # get policy's q-value
        return value
    ...
    def computeActionFromQValues(self, state):
        ...
        for action in actions:
            ...
            if qvalue > bestValue:
                bestAction, bestValue = action, qvalue
        return bestAction
    ...
    def update(self, state, action, nextState, reward):
        ...
        qvalue += self.alpha * (reward + self.discount * nextValue - qvalue)
